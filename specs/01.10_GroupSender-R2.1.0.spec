Herramientas gráficas de "Envíos masivos a grupos" y "Batch Monitor"  - Iniciando_spec: 01.10_GroupSender-R2.1.0
==================================================================
Tags:GS,massive
...
DEPENDENCIAS.- 
	...
	3.- En el paso del escenario 'ProgramarEnvio' se le pasa como parámetro el nombre de la plantilla que vamos a utilizar.
...
* EnviosProgramadosR210 "esperar que acabe"
h1.
Se realizan 10K envios, y SIN plantillas. Prioridad 'MEDIA'
GroupSender, Almacen de Datos:
* Archivo "agenda10k_sms.csv"
* ProgramarEnvio "TextoAgenda 10k destinatarios" "--" "planificar" "5"
* EnviosProgramadosR210 "esperar que acabe"
